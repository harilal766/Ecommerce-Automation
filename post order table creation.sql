	...
	Fulfillment_Status VARCHAR(20),	Fulfilled_at TIMESTAMP,	Accepts_Marketing BOOLEAN,	Currency VARCHAR(50),
	Subtotal NUMERIC(10,2),	Shipping VARCHAR(50),	Taxes NUMERIC(10,2),	Total NUMERIC(10,2),
	Discount_Code BOOLEAN,	Discount_Amount BOOLEAN,	Shipping_Method VARCHAR(50),	Created_at TIMESTAMP,
	...
	Tags VARCHAR(50),	Risk_Level BOOLEAN,	Source VARCHAR(50),	Lineitem_discount BOOLEAN,
